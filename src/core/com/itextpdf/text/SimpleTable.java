...
public class SimpleTable extends Rectangle implements PdfPTableEvent, TextElementArray {
	 ...
	 * @return a com.itextpdf.text.Table object
	 * @throws BadElementException
	 */
	...
	/**
     * @see com.itextpdf.text.pdf.PdfPTableEvent#tableLayout(com.lowagie.text.pdf.PdfPTable, float[][], float[], int, int, com.lowagie.text.pdf.PdfContentByte[])
 	 */
