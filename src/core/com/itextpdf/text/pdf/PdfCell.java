 ...
 * <P>
 * When using variable borders ({@link com.itextpdf.text.Rectangle#isUseVariableBorders isUseVariableBorders()} == true),
...
public class PdfCell extends Rectangle {
     ...
     * @param side the side to check.  One of the side constants in {@link com.itextpdf.text.Rectangle}
